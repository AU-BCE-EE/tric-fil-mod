...
k=0
kl_list = np.linspace(0.00000001, 0.000005,5) 
...
plt.savefig('Plots/Experiment '+first+'.'+second+'kl liq.png', bbox_inches='tight')
plt.close()
...
plt.title('Experiment '+first+'.'+second+' baseline liq')
