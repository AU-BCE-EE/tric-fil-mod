...
k = 0       # Reaction rate (1/s) for H2S. Small because of inert carrier
k2 = k  # Reaction rate for HS- (1/s)           
...
#plt.plot(pred3['time'] / 3600, pred3['gas_conc'][nc - 1, :],label=pred3label)
#plt.plot(pred4['time'] / 3600, pred4['gas_conc'][nc - 1, :],label=pred4label)
...
plt.axvline(x=0.095,label='inflection time')
plt.xlabel('Time (h)')
