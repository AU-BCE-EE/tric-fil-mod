...
for i, k in enumerate(k_list):
    ...
    for j, kl in enumerate(kl_list):
        ...
        plt.savefig('Plots/Experiment '+label+'.png', bbox_inches='tight')
        plt.close()
        ...
        plt.savefig('Plots/Experiment '+label+'residuals.png', bbox_inches='tight')
        plt.close()
        ...
        # Save the figure
        plt.savefig('Plots/Inputs/Input_parameters_'+label+'.png', bbox_inches='tight')
        ...
        plt.legend()
        plt.subplot(111).legend(loc='upper center',bbox_to_anchor=(0.5,-0.2)) #Moves legend out of plot
        plt.savefig('Plots/Experiment '+label+' gasprofile.png', bbox_inches='tight')
        plt.close()
        ...
        plt.legend()
        plt.subplot(111).legend(loc='upper center',bbox_to_anchor=(0.5,-0.2)) #Moves legend out of plot
        plt.savefig('Plots/Experiment '+label+' liqprofile.png', bbox_inches='tight')
        plt.close()
