...
for i, k in enumerate(k_list):
    pred = tfmod(L=L, por_g=por_g, por_l=por_l, v_g=v_g, v_l=v_l, nc=nc, cg0=cg0, cl0=cl0,
                 ...
                 pH=pH1, temp=temp, dens_l=dens_l, times=times, v_res=v_res, kg = 'onda', kl = 0.0001, ae=800, 
...
pred1 = tfmod(L = L, por_g = por_g, por_l = por_l, v_g = v_g, v_l = v_l, nc = nc, cg0 = cg0, 
              ...
              pH = pH1, temp = temp, dens_l = dens_l, times = times, v_res = v_res, kl = 0.0001, ae=800, recirc = True, counter = True)
...
plt.savefig('Plots/Experiment '+first+'.'+second+'k steady state kl 1e-4.png', bbox_inches='tight')
plt.close()
