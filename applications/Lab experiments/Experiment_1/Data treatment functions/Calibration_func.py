...
#start time
startcyclecali=20 #Row of data where the calibration starts
endcyclecali=700 #Row of data where the calibration ends

#actual concentration in ppm
C_actual=40

#specify excel file (put the excel file in Raw_data)
filename = 'calibrering 2 40ppm'
...
plt.title('Calibration Curve 04.10')
plt.legend(loc='lower right')
plt.savefig('..//Plots/Calibration_04.10.24.png')
