...
ex1=Data_reciever(filename='experiment_3.3.inlet1.csv',startcycle=120,stopcycle=1820,a=constant1,b=constant2
                  )
...
ex2=Data_reciever(filename='experiment_3.2.1.csv',startcycle=75,stopcycle=1800,a=constant1,b=constant2)
