...
for i in range(1,8):
    ...
    pred1 = tfmod(L = L, por_g = por_g, por_l = por_l, v_g = v_g, v_l = v_l, nc = nc, cg0 = cg0, 
                  ...
                  pH = pH1, temp = temp, dens_l = dens_l, times = times, v_res = v_res, recirc = False, counter = True)
    pred1label= 'v_res = on, recirc = off, counter = on' 
...
plt.title('pH comparison '+pred1label)
plt.savefig('Plots/pH comparison '+pred1label+'.png', bbox_inches='tight')
plt.close()
