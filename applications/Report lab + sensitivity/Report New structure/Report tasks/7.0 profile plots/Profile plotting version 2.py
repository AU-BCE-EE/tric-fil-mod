...
# plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 50], label = 'Gas phase concentration at time:%1.2f'%times[50]+'min',color = 'b')
# plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 50]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[50]+'min',color='b',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 100], label = 'Gas phase concentration at time:%1.2f'%times[100]+'min',color ='b')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 100]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[100]+'min',color='b',linestyle = 'dashed')
