...
for i, k in enumerate(k_list):
    pred = tfmod(L=L, por_g=por_g, por_l=por_l, v_g=v_g, v_l=v_l, nc=nc, cg0=cg0, cl0=cl0,
                 ...
                 pH=pH, temp=temp, dens_l=dens_l, times=times, v_res=v_res, kg = 'onda', kl = 'onda', ae='onda', k2=k, 
                 recirc=True, counter=True)
    
    
    label = f"k = {k:.3g} 1/s outlet"
...
plt.title('Reaction rate variation')
plt.savefig('Plots/K variation for report.png', bbox_inches='tight')
plt.close()
