...
ex1 = pd.read_csv('Output data/experimental_delay_6.1.csv', sep = ',')
model1 = pd.read_csv('Output data/model_delay_6.1.csv', sep = ',')
ex1['Moving_Average'] = ex1['experimental'].rolling(window=window_size,center = True).mean()

ex2 = pd.read_csv('Output data/experimental_delay_6.2.csv', sep = ',')
model2 = pd.read_csv('Output data/model_delay_6.2.csv', sep = ',')
ex2['Moving_Average'] = ex2['experimental'].rolling(window=window_size,center = True).mean()

ex3 = pd.read_csv('Output data/experimental_delay_6.3.csv', sep = ',')
model3 = pd.read_csv('Output data/model_delay_6.3.csv', sep = ',')
ex3['Moving_Average'] = ex3['experimental'].rolling(window=window_size,center = True).mean()

ex4 = pd.read_csv('Output data/experimental_delay_6.4.csv', sep = ',')
model4 = pd.read_csv('Output data/model_delay_6.4.csv', sep = ',')
...
plt.savefig('Ex 6 velocity comparison.png', bbox_inches='tight')
