...
# Gas
plt.clf()
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 10], label = 'Gas phase concentration at time:%1.2f'%times[10]+'min',color = 'b')
plt.plot(pred1['cell_pos'], (pred1['liq_conc'][:, 10])*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[10]+'min',color='b',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 30], label = 'Gas phase concentration at time:%1.2f'%times[30]+'min',color ='r')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 30]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[30]+'min',color='r',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 45], label = 'Gas phase concentration at time:%1.2f'%times[45]+'min',color = 'c')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 45]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[45]+'min',color='c',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 50], label = 'Gas phase concentration at time:%1.2f'%times[50]+'min',color = 'y')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 50]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[50]+'min',color='y',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 100], label = 'Gas phase concentration at time:%1.2f'%times[100]+'min',color ='k')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 100]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[100]+'min',color='k',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 150], label = 'Gas phase concentration at time:%1.2f'%times[150]+'min',color = 'm')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 150]*Daw, label = 'Equilibrium w/ liq at time:%1.2f'%times[150]+'min',color='m',linestyle = 'dashed')
...
#Liquid
plt.clf()
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 10], label = 'Time:%1.0f'%times[10]+'s',color = 'b')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 10]/Daw, label = 'Equilibrium w/gas at time:%1.0f'%times[10]+'s',color='b',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 30], label = 'Time:%1.0f'%times[30]+'s',color = 'r')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 30]/Daw, label = 'Equilibrium w/ gas at time:%1.0f'%times[30]+'s',color='r',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 50], label = 'Time:%1.0f'%times[50]+'s',color = 'y')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 50]/Daw, label = 'Equilibrium w/ gas at time:%1.0f'%times[50]+'s',color='y',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 100], label = 'Time:%1.0f'%times[100]+'s', color = 'k')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 100]/Daw, label = 'Equilibrium w/ gas at time:%1.0f'%times[100]+'s',color='k',linestyle = 'dashed')
plt.plot(pred1['cell_pos'], pred1['liq_conc'][:, 150], label = 'Time:%1.0f'%times[150]+'s',color = 'm')
plt.plot(pred1['cell_pos'], pred1['gas_conc'][:, 150]/Daw, label = 'Equilibrium w/ gas at time:%1.0f'%times[150]+'s',color='m',linestyle = 'dashed')
plt.xlabel('Location (m)')
plt.ylabel('Compound conc. (g/m3)')
