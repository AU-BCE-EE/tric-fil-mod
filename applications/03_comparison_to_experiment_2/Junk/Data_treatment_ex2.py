...
name1='2.1.inlet1.csv' #name of file

#start and stop times
cycle_start1=120 #CHANGE_ME
cycle_stop1=1800 #CHANGE_ME
...
with open(name1) as file1: 
    ...
    header1=next(data1)
    for row in data1:
        time_s1= float(row[header1.index('Relative Time')])
...
name2='experiment_2.1.1.csv' #file name

#start and stop times
cycle_start2=75 #CHANGE_ME
cycle_stop2=1800 #CHANGE_ME
...
with open(name2) as file2: 
    ...
    header2=next(data2)
    for row in data2:
        time_s2= float(row[header2.index('Relative Time')])
...
name3='experiment_2.1.2.csv' #file name

#start and stop times
cycle_start3=100 #CHANGE_ME
cycle_stop3=1800 #CHANGE_ME
...
with open(name3) as file3: 
    ...
    header3=next(data3)
    for row in data3:
        time_s3= float(row[header3.index('Relative Time')])
...
name4='experiment_2.1.3.csv' #file name

#start and stop times
cycle_start4=140 #CHANGE_ME
cycle_stop4=1800 #CHANGE_ME
...
with open(name4) as file4: 
    ...
    header4=next(data4)
    for row in data4:
        time_s4= float(row[header4.index('Relative Time')])
...
name5='experiment_2.1.inlet2.csv' #file name

#start and stop times
cycle_start5=95 #CHANGE_ME
cycle_stop5=1800 #CHANGE_ME
...
with open(name5) as file5: 
    ...
    header5=next(data5)
    for row in data5:
        time_s5= float(row[header5.index('Relative Time')])
...
# name6='ex_2.6.1.csv' #file name

# #start and stop times
# cycle_start6=100 #CHANGE_ME
# cycle_stop6=460 #CHANGE_ME
