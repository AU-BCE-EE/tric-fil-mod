...
from lab_parameters_62 import pH1,pH2,cycle1,cycle2,cycle3,cycle4,length,vol 
...
C2= ex2['Concentration in g/m^3'][cycle2:cycle2+length+1500]

t3norm = ex3['Time in h'] - ex3['Time in h'][cycle3]
t3 = t3norm [cycle3:cycle3+length+1500]
C3= ex3['Concentration in g/m^3'][cycle3:cycle3+length+1500]
