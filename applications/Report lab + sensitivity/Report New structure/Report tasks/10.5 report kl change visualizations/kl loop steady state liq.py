...
plt.plot(pred1['time'] / 60, pred1['liq_conc'][nc - 1, :],label=pred1label)
plt.xlabel('Time (min)')
...
plt.savefig('Plots/Experiment '+first+'.'+second+'kl steady state, k 0, liq.png', bbox_inches='tight')
plt.close()
...
plt.title('Experiment '+first+'.'+second+' baseline liq SS')
