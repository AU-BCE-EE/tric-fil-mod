# -*- coding: utf-8 -*-
"""
Created on Thu May 30 14:46:23 2024
...
for i, k in enumerate(k_list):
    pred = tfmod(L=L, por_g=por_g, por_l=por_l, v_g=v_g, v_l=v_l, nc=nc, cg0=cg0, cl0=cl0,
                 ...
                 pH=pH, temp=temp, dens_l=dens_l, times=times, v_res=v_res, kg = 'onda', kl = 'onda', ae='onda', k2=0, 
                 recirc=True, counter=True)
    
    
    label = f"k1 = {k:.3g} 1/s outlet"
...
plt.title('Reaction rate variation, k2=0, pH=8')
plt.savefig('Plots/K variation k2=0 pH 8.png', bbox_inches='tight')
plt.close()
