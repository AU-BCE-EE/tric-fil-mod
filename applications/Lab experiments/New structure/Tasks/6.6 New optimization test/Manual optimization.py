...
k_list = [0,0.001,0.004,0.008,0.01]
...
for i, k in enumerate(k_list):
    kl_list = [0.0000005,0.000007,0.000001,0.000002,0.000004]
...
norm = Normalize(vmin=df['MAE'].min(), vmax=df['MAE'].max())
